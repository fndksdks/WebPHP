            ...
            <div class="login_part_form">
                ...
                <div class="login_part_form_iner">
                    ...
                    if (isset($_POST["dangky"])) {
                        ...
                        if ($ten != "") {
                            if ($email != "" && !isset($errorEmail)) {
                            
                                if ($sdt != "" && !isset($errorPhone)) {
                                    if ($matkhau != "") {
                                        if ($matkhau !== $nlmatkhau) {
                                            $error = 'Nhập lại mật khẩu không chính xác';
                                        } else {
                                            //var_dump(rowCount("SELECT * FROM taikhoan WHERE taikhoan='$email'")); die;
                    ...
                    <form class="row contact_form" action="" method="post" novalidate="novalidate">
                        ...
                        <div class="col-md-12 form-group p_star">
                            <input type="number" class="form-control" name="sdt" value="" placeholder="SDT" required>
                        </div>
                        <div class="col-md-12 form-group p_star">
