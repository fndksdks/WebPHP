                        ...
                        <div class="s_product_text">
                            ...
                            <ul class="list">
                                ...
                                <li>
                                    ...
                                    <span>Số lượng</span> : <?= $soluong > 0 ? $soluong : 0 ?>
                                </li>
                            </ul>
                            <p>
                                <?= $mota ?>
                                    ...
                                    if (isset($_COOKIE["user"])) {
                                        if ($soluong >= $_POST["soluong"]) {
                                            ...
                                            if (rowCount("SELECT * FROM donhang WHERE status=0 && id_taikhoan=$id_nguoidung") > 0) {
                                                ...
                                                selectAll("INSERT INTO donhang VALUES(null,$id_nguoidung,0,0,null,'{$today}')");
                                                foreach (selectAll("SELECT * FROM donhang WHERE status=0 && id_taikhoan=$id_nguoidung") as $item) {
                                                    $idDhmoi = $item['id'];
                                                }
                                            ...
                                            echo "<script>alert('Số lượng sản phâm trong kho không đủ để đặt mua')</script>";
                                        }
                                    } else {
                                            ...
                                            ?>
                                                    ...
                                                    <div class="review_item reply">
                                                        ...
                                                        <form action="" method="POST" class="form-rep">
                                                            ...
                                                            <button class="genric-btn primary-border small" style="float: right; margin-top:5px" id="cancelButton">Huỷ</button>
                                                        </form>
                                                    </div>
                                            <?php
                                                }
