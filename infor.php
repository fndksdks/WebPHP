                        ...
                        <div class="login_part_form_iner">
                            <?php 
                                ...
                                if (isset($_POST["doithongtin"])) {
                                    ...
                                    if (empty($_POST["sdt"])) {
                                        $errorPhoneEmpty = "Định dạng số điện thoại không chuẩn xác";
                                    }
                                    if (isset($_POST['sdt']) && !preg_match('/^0[0-9]{9}$/', trim($_POST['sdt']))) {
                                        $errorPhone = "Định dạng số điện thoại không chuẩn xác";
                                    }
                                    if (!isset($errorPhone) && !isset($errorPhoneEmpty)) {
                                        ...
                                        $error = $errorPhone ?? '';
                                        if (isset($errorPhoneEmpty)) {
                                            $error = $errorPhoneEmpty;
                                        }
                            ...
                            <?php
                                ...
                                <div class="col-md-12 form-group p_star">
                                    <p>SDT*</p>
                                    <input type="number" id="sdt" class="form-control"  name="sdt" value="<?= $sdtcu ?>" placeholder="SDT" required>
                                </div>
                                <div class="col-md-12 form-group p_star">
                                    <p>Địa Chỉ*</p>
