                ...
                <div class="table-responsive">
                  <table class="table">
                    ...
                    <tbody>
                      ...
                      foreach (selectAll("SELECT * FROM donhang WHERE status= 1 OR status= 2 OR status= 3 OR status= 4 LIMIT $item_per_page OFFSET $offset") as $row) {
                      ?>
                        <tr class="addfont">
                          <td><?= $stt++ ?></td>
                          <td>
                        ...
                        <td>
                          ...
                          if ($status == 1) {
                          ?>
                            <a type="button" class="btn btn-success btn-icon-text" style="width: 130px" href="updateorder.php?id=<?= $row['id'] ?>&action=confirm" onclick="return confirm('Bạn có muốn xác nhận đơn hàng này không?')">
                              <i class="mdi mdi-trending-up btn-icon-prepend"></i> Xác Nhận </a>
                          <?php
                          } else if ($status == 2) {
                          ?>
                            <a type="button" class="btn btn-success btn-icon-text" style="width: 130px" href="updateorder.php?id=<?= $row['id'] ?>&action=complete" onclick="return confirm('Bạn có muốn hoàn thành đơn hàng này không?')">
                          ...
                          if ($status == 1) {
                          ?>
                            <a type="button" class="btn btn-danger btn-icon-text" href="updateorder.php?id=<?= $row['id'] ?>&action=cancel" onclick="return confirm('Bạn có muốn hủy đơn hàng này không?')">
